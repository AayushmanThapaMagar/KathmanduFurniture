      ...
      <div className="flex flex-wrap flex-row items-center justify-center">
        {data.map((collection) =>
          collection.title === 'Featured Products' ? (
            ...
            >
                <div
                className="z-10 absolute bg-gray-100 lg:w-[150px] lg:h-[150px] flex items-center justify-center bg-opacity-85 rounded-lg text-center h-32 w-32"
                >
                <h1> View 
                    All</h1>
                </div>
